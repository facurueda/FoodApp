...
<head>
    <title>Code coverage report for jsonCache.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> jsonCache.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { flatten, unflatten } from './flat';
...
export default class JSONCache implements IJSONCache {
   ...
   */
  constructor(private redisClient: any, private options: IOptions = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    this.options.prefix = options.prefix || <span class="branch-1 cbranch-no" title="branch not covered" >'jc:';</span>
  }
&nbsp;
  /**
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Dec 17 2019 13:54:32 GMT+0530 (India Standard Time)
            </div>
        </div>
