...
<head>
    <title>Code coverage report for flat.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> flat.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">502x</span>
<span class="cline-any cline-yes">502x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">150x</span>
...
<span class="cline-any cline-yes">368x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { IObj } from './interfaces';
&nbsp;
/**
...
&nbsp;
      ...
      tmp = tmp[k1];
      <span class="missing-if-branch" title="else path not taken" >E</span>if (++i &lt; split.length) {
        k1 = getkey(split[i]);
        k2 = getkey(split[i + 1]);
      }
    }
